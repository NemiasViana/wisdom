  ...
  const news = [
    {
      ...
      summary: "Banco digital superou todas as expectativas com crescimento explosivo de 45% em wealth management e 60% em investment banking.",
    ...
    },
    {
      ...
      summary: "Maior aquisição da história da empresa marca entrada definitiva no mercado de inteligência artificial empresarial.",
    ...
    {
      id: 3,
      title: "⚡ Bitcoin HISTÓRICO: Aprovação de ETF Spot gera tsunami institucional",
      summary: "CVM aprova primeiro ETF de Bitcoin spot do Brasil. Entrada institucional massiva de R$ 4.2 bilhões em 48 horas.",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { 
                  ...
                  change: `${portfolioStats.returnPercentage > 0 ? '+' : ''}${portfolioStats.returnPercentage.toFixed(1)}%`, 
                  icon: Diamond
                },
                { 
                  title: 'AI Confidence', 
                ...
                { 
                  title: 'ESG Score', 
                  value: portfolioStats.avgEsgScore.toFixed(1), 
                  change: '+5.2', 
                  icon: Leaf
                },
                { 
                  title: 'Edge Latency', 
                  value: `${edgeLatency}ms`, 
                  change: 'Ultra Low', 
                  icon: Zap
                }
              ].map((stat, index) => (
